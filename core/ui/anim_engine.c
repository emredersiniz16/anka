 ...
 * BİRLEŞTİRİLMİŞ: Uyanış Sekansı + Koordinat Motoru (Nihai Sürüm)
 */
...
// Terminal akışı ve ASCII yedekler
...
// Güvenli ms gecikme fonksiyonu (Implicit declaration uyarısı engellendi)
